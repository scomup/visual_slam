...
#ifndef VISUAL_SLAM_TRANSFORM_TRANSFORM_INTERPOLATION_BUFFER_H_
#define VISUAL_SLAM_TRANSFORM_TRANSFORM_INTERPOLATION_BUFFER_H_
...
#endif  // VISUAL_SLAM_TRANSFORM_TRANSFORM_INTERPOLATION_BUFFER_H_
