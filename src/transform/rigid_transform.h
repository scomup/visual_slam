...
#ifndef VISUAL_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
#define VISUAL_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
...
std::ostream& operator<<(std::ostream& os,
                         const visual_slam::transform::Rigid3<T>& rigid) {
...
#endif  // VISUAL_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
